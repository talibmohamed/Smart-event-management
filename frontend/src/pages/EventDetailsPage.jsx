...
import EventWaitlistPanel from "../components/event/EventWaitlistPanel";
        ...
        <CardBody className="gap-6 p-6 md:p-8">
          {isLoading ? (
            ...
            <>
              ...
              {!canEditEvent && isAttendee && availability.isFull ? (
                <EventWaitlistPanel eventId={eventRecord.id} isVisible />
              ) : null}
